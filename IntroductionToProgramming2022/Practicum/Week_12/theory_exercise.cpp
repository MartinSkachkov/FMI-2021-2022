...
int main() {
    ...
    // int *num1 = nullptr;
    // {
    //     int* num2 = new int; //dinamichno zatova ne se bastisva ot
    //     kompilatora *num2 = 4; num1 = num2; //set num1 to point the adress of
    //     num2
    // }
    ...
    int* num3 = nullptr;
    {
        int* num4;  // uninitialized var causing error
        *num4 = 4;
        num3 = num4;
    }
